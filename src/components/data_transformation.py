...
class DataTransformation:
    ...
    def preprocess_data(self):
        ...
        grouped_data_df.to_csv(self.config.transformed_data, index=False)
    ...
    def one_hot_preprocess(self):
        ...
        logger.info("random forest selection features started ........")
        rfr.fit(scaled_X, y)
        ...
        with open(self.config.model_feature_path, 'wb') as f:
            pickle.dump(rfr, f)
        logger.info("saving random forest model for prediction ........")
